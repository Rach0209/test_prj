...
<link rel="stylesheet" href="/resources/com/js/lib/bootstrap/css/bootstrap.min.css" type="text/css">
					<!-- css-user -->
<link rel="stylesheet" href="/resources/gis/js/map/css/map.css" type="text/css">
...
<script src="/resources/com/js/lib/bootstrap/js/bootstrap.bundle.min.js"></script>
					...
					<!-- javascript-user -->
<script src="/resources/gis/js/map/js/2d/map2d.js"></script>
<script src="/resources/gis/js/map/js/3d/map3d-module-beta.js"></script>
</html>